...
<div class="bg-gradient-to-r from-gray-700 via-gray-900 to-black dark:bg-gray-900">
    <section
            class="flex flex-wrap justify-center items-center text-center w-full bg-gradient-to-r from-purple-400 to-pink-600">
        <div
                bind:this={card}
    ...
    <div class="rounded-lg w-full h-screen bg-gradient-to-r from-gray-700 via-gray-900 to-black">
        <GamesWorkedOn/>
        <div class="rounded-lg w-full h-screen bg-gradient-to-r from-gray-700 via-gray-900 to-black">
            <h1 class="text-4xl font-bold text-center col-span-4 text-white p-4">Play Space bound here for fun while I slowly add more of my experience and projects</h1>
            <iframe
